...
public class VersionedIntervalTimelineTest
{
  ...
  @Test
  public void testLookupDoesNotReturnIntervalsOutOfRange()
  {
    final Interval lookupInterval = Intervals.of("2019-10-09T11:00:00.000Z/2019-10-09T11:10:00.000Z");
    final Interval segmentInterval = Intervals.of("2019-10-09T11:00:00.000Z/2019-10-09T12:00:00.000Z");

    timeline = makeStringIntegerTimeline();

    // Partition generated by updater
    add(segmentInterval, "2019-10-09T11:01:00.509Z_gen_00001628", NumberedPartitionChunk.make(0, 1, 0));

    // Partition not yet processed by updater
    add(segmentInterval, "2019-10-09T11:01:00.509Z", NumberedPartitionChunk.make(1, 1, 1));

    List<TimelineObjectHolder<String, Integer>> found = timeline.lookup(lookupInterval);

    Assert.assertEquals(2, found.size());

    for (TimelineObjectHolder<String, Integer> entry : found) {
      Assert.assertTrue("Timeline entry is within requested interval", lookupInterval.contains(entry.getInterval()));
    }
  }
